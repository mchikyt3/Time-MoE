...
def create_pooling_test_datasets():
    ...
    return [
        ("early_pattern_detection.jsonl", "Early Pattern Detection", ["attention", "multi_scale"]),
        ("global_statistics.jsonl", "Global Statistics", ["mean", "max", "multi_scale"]),
        ("temporal_evolution.jsonl", "Temporal Evolution", ["last_token", "weighted_temporal", "conv_pool"])
    ]
    ...
    strategies = [
        {
            ...
            "best_for": ["Sequential patterns", "Temporal dependencies", "State evolution"],
            "example": "Stock price trends, speech recognition final states"
        },
        {
            "name": "mean",
            "description": "Average of all timestep representations",
            "best_for": ["Global statistics", "Overall signal characteristics", "Stable patterns"],
        ...
        },
        {
            ...
            "best_for": ["Variable-length patterns", "Complex temporal relationships", "Multi-scale features"],
            "example": "Document classification, irregular heartbeats"
        },
        {
            "name": "multi_scale",
            "description": "Combines mean, max, and last token",
            "best_for": ["Complex patterns", "Robust classification", "Unknown pattern types"],
        ...
        },
        {
            ...
            "best_for": ["Recent events more important", "Trend analysis", "Recency bias"],
            "example": "Real-time monitoring, recent trend classification"
        },
        {
            "name": "conv_pool",
            "description": "1D convolution followed by pooling",
            "best_for": ["Local patterns", "Feature extraction", "Translation invariance"],
...
def print_training_examples():
    ...
    for dataset_file, dataset_name, recommended_strategies in datasets:
        ...
        for strategy in recommended_strategies:
            ...
            print(f"      --task_type sequence_classification \\")
            print(f"      --num_classes 3 \\")
            print(f"      --pooling_strategy {strategy} \\")
            print(f"      --micro_batch_size 4 \\")
            print(f"      --train_steps 100 \\")
